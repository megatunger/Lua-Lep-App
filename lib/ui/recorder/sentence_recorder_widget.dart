...
class SentenceRecorderWidget extends StatefulWidget {
  final LocalFileSystem localFileSystem;
  final String sentence;
  SentenceRecorderWidget({localFileSystem, this.sentence})
      : this.localFileSystem = localFileSystem ?? LocalFileSystem();

  @override
  State<StatefulWidget> createState() => new SentenceRecorderWidgetState();
}

class SentenceRecorderWidgetState extends State<SentenceRecorderWidget> {
  ...
  Future uploadFile(File file) async {
    ...
    if (this.widget.sentence!=null) {
      await sentenceCheckBloc.checkSentence(this.widget.sentence, file.basename);
//      await sentenceCheckBloc.checkSentence('lúa nếp là lúa nếp vang', 'audio_record_-gLxNQsjH5HqrTweMC0mYkhvQxqg4XcXeNOpAAQAkbg=.wav');
